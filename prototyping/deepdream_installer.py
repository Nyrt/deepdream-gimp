...
if opsys == "linux" or opsys == "linux2" or opsys == "linux3":
    ...
    dir2 = os.path.expanduser("~") + "/.gimp-2.8/plug-ins/"
elif opsys == "darwin":
    # using mac os
    dir1 = "/Library/Application Support/GIMP/2.8/plug-ins/"
    dir2 = "/Applications/GIMP.app/Contents/Resources/lib/gimp/2.0/plug-ins/"
